...
### Visualize team Alpha Romeo and its winners

The density plot/voilin plot below visualizes the most successful drivers of team Alpha Romeo/Ferrari:
most wins by team
...
df_top_teams <- df_team[order(df_team$winner),] %>% top_n(10)


ggplot(data=df_top_teams, aes(x=team, y=winner,group=1)) +
  geom_line(color="salmon", size=2) +
  geom_point(color="chocolate", size=3.5) +
  ggtitle("Scatterplot of top 10 F1 race tracks") +
  labs(x="", y="Average value of laps\nper race track") +
...
```
The line graph above shows the top ten teams with the most number of wins during seasons 1050-2020. As illustrated in the graph, team Ferrari secured significantlu higher wins i.e. 239 than its counterparts. Second highest wins were secured by Mercedes followed by McLaren Mercedes on the third position.
